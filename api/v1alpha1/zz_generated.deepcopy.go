...
func (in *ConfigSpec) DeepCopyInto(out *ConfigSpec) {
	*out = *in
	if in.KuboAppRedirects != nil {
		in, out := &in.KuboAppRedirects, &out.KuboAppRedirects
		*out = make([]*KuboAppRedirectSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(KuboAppRedirectSpec)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KuboAppRedirectSpec) DeepCopyInto(out *KuboAppRedirectSpec) {
	*out = *in
	in.OciAddOn.DeepCopyInto(&out.OciAddOn)
	out.Interval = in.Interval
	if in.Timeout != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KuboAppRedirectSpec.
func (in *KuboAppRedirectSpec) DeepCopy() *KuboAppRedirectSpec {
	if in == nil {
		return nil
	}
	out := new(KuboAppRedirectSpec)
