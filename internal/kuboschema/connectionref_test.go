...
func TestDesugarConnectionRefScalar(t *testing.T) {
	...
	if !ok || marker["contract"] != "database-server" {
	...
	if len(decls) != 1 || decls[0].Contract != "database-server" || !decls[0].Required {
		...
		"properties": map[string]interface{}{
			"datasources": map[string]interface{}{
				"items": map[string]interface{}{
					"properties": map[string]interface{}{
						"trino":   map[string]interface{}{"type": TypeConnectionRef, "contract": "trino", "required": true},
		...
		"properties": map[string]interface{}{
			"list": map[string]interface{}{
				"items": map[string]interface{}{
					"properties": map[string]interface{}{
						"db": map[string]interface{}{
							"type": TypeConnectionRef, "contract": "database-server",
	...
	schema := KuboSchema{
		"properties": map[string]interface{}{
			"ports": map[string]interface{}{
				"properties": map[string]interface{}{
					"8080": map[string]interface{}{"type": TypeConnectionRef, "contract": "trino"},
				},
			},
		},
	}
