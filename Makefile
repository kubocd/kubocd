...
crds: manifests kustomize ## Generate crds file into helm chart
	$(KUSTOMIZE) build config/crd -o helm/kubocd-controller/crds/crds.yaml
...
chart-yaml: ## Generate the helm/kcd-controller/Chart.yaml
	echo "$$CHART_YAML" >./helm/kubocd-controller/Chart.yaml

.PHONY: chart
chart: chart-yaml crds ## Build and push helm chart
	cd ./helm && helm package -d ./../tmp kubocd-controller && helm push ./../tmp/kubocd-${HELM_VERSION}.tgz oci://${HELM_DOCKER_REPO}
